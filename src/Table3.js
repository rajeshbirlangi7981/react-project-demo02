...
function Table3({ title, items }) {
  return (
    <div className="w-[calc(50vw+5px)] h-[50vh] m-3 mx-1 bg-gray-700 rounded-xl p-5 shadow-md flex flex-col justify-start items-center">
      ...
      <div className="w-full mb-2">
        <div className="flex justify-around mb-1 font-bold text-white">
          ...
          <span className="flex-1 text-left -ml-3 text-red-400">IntraVolume</span>
        ...
        <ul className="text-white list-none">
          {items.map((item, index) => (
            <li key={index} className="flex justify-between px-2 py-2 border-none">
              ...
              <span className="flex-1 text-left">{item.intraVolume}</span>
